// ==================== LOCAL STORAGE SYSTEM ====================
        ...
        document.getElementById('btn-auto').onclick = function() {
          alert('Auto clicked!');
          // Tambahkan fungsi auto sesuai kebutuhan
        };

        document.getElementById('btn-power').onclick = function() {
          alert('Power clicked!');
          // Tambahkan fungsi power sesuai kebutuhan
        };

        document.getElementById('btn-toko').onclick = function() {
          alert('Toko dibuka!');
          // Tambahkan fungsi buka toko
        };

        document.getElementById('btn-item').onclick = function() {
          alert('Item dibuka!');
          // Tambahkan fungsi buka item
        };

        document.getElementById('btn-prestasi').onclick = function() {
          alert('Prestasi dibuka!');
          // Tambahkan fungsi buka prestasi
        };
