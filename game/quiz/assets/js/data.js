...
/**
 * Data User Default
 * Data ini akan di-override dari localStorage jika sudah ada
 * Menyimpan informasi tentang profil user, inventory, achievements, dan level yang sudah diselesaikan
 */
let userData = {
  username: "Guest",
  level: 1,
...
// ========== VALIDASI DATA ==========
/**
 * Fungsi untuk memastikan struktur data inventory valid
 * Mencegah error jika ada properti yang hilang
 */
function ensureInventoryStructure() {
  ...
  // Pastikan setiap properti dalam inventory ada
...
/**
 * Data kategori quiz
 * Berisi informasi tentang setiap kategori termasuk jumlah level
 */
const categoryData = [
  {
    id: "science",
...
// ========== DATA ACHIEVEMENTS ==========
/**
 * Data Achievement yang mungkin diraih pemain
 * Berisi informasi tentang pencapaian, deskripsi, dan ikon
 */
...
// ========== DATA PROFIL IKON ==========
/**
 * Opsi ikon profil yang tersedia
 * User dapat mengganti ikon profil mereka
 */
const profileIcons = [
...
// ========== DATA QUIZ ==========
/**
 * Data pertanyaan untuk setiap kategori dan level
 * Struktur: quizData[kategori][level][array pertanyaan]
 */
const quizData = {
  "science": {
    1: [
...
/**
 * Mendapatkan data level untuk kategori tertentu
 * @param {string} categoryId - ID kategori
 * @return {Array} Array berisi level dan status (locked, unlocked, completed)
 */
...
/**
 * Mendapatkan pertanyaan untuk level tertentu
 * @param {string} categoryId - ID kategori
 * @param {number} level - Nomor level
 * @return {Array} Array berisi pertanyaan untuk level
 */
...
// ========== FUNGSI MANAJEMEN ACHIEVEMENTS ==========
/**
 * Memeriksa dan menambahkan achievement yang telah dicapai
 * Dipanggil setelah level selesai dan saat melakukan tindakan penting
 */
...
/**
 * Memeriksa apakah user sudah memiliki achievement tertentu
 * @param {string} achievementId - ID achievement yang akan diperiksa
 * @return {boolean} true jika sudah memiliki, false jika belum
 */
...
/**
 * Menambahkan achievement baru ke user
 * @param {string} achievementId - ID achievement yang akan ditambahkan
 * @param {Object} extraData - Data tambahan untuk achievement (opsional)
 */
...
// ========== FUNGSI PROGRESS GAME ==========
/**
 * Menyimpan penyelesaian level dan menambah reward
 * @param {string} categoryId - ID kategori
 * @param {number} level - Nomor level
 * @param {number} score - Skor yang didapat
 * @return {Object} Object berisi coins dan XP yang didapat
 */
...
/**
 * Memeriksa apakah user naik level
 * Level baru didapat saat XP mencapai threshold tertentu
 */
 ...
 * Menyimpan data user, daftar user, dan user aktif
 */
 ...
 * Menyimpan data saat ini, lalu hapus indikator user aktif
 */
function logoutUser() {
...
/**
 * Fungsi helper untuk redirect ke halaman login
 * Mencegah redirect loop dengan flag
 */
 ...
 * Menghapus semua data dari localStorage dan reset ke default
 */
...
// ========== INISIALISASI ==========
/**
 * Coba load data saat aplikasi dimulai
